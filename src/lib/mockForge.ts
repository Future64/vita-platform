...
export const MORE_DEMANDES_INTEGRATION: ForgeDemandeIntegration[] = [
  {
    id: "mr-4",
    number: 37,
    title: "Correction typos article 9",
    description: "Corrections orthographiques mineures dans l'article 9 de la constitution.",
    project: "Constitution v3.0",
    projectId: "constitution-v3",
    author: "Sophie Chen",
    authorInitials: "SC",
    ...
    comments: [],
    created: "il y a 5j",
    createdIso: "2025-01-10T09:00:00Z",
    updated: "il y a 3j",
  },
  {
    id: "mr-5",
    number: 36,
    title: "Feature: Quorum dynamique basé sur la participation",
    description: `## Résumé\n\nLe quorum est désormais calculé dynamiquement en fonction du taux de participation moyen des 30 derniers jours.\n\n## Changements\n\n- Algorithme de calcul du quorum adaptatif\n- Seuil minimum configurable\n- Tests unitaires complets`,
    project: "Système de Vote v2",
    projectId: "voting-system",
    author: "Fatima Benali",
    authorInitials: "FB",
    ...
    created: "il y a 4j",
    createdIso: "2025-01-11T16:00:00Z",
    updated: "il y a 1j",
  },
  {
    id: "mr-6",
    number: 35,
    title: "Refactor: Simplification du module de redistribution",
    description: "Refactorisation du module de redistribution pour réduire la complexité cyclomatique et améliorer la lisibilité.",
    project: "Système de Vote v2",
    projectId: "voting-system",
    author: "Alex Rivera",
    authorInitials: "AR",
    ...
    comments: [
      {
        ...
        author: "Sophie Chen",
        authorInitials: "SC",
        content: "Belle simplification ! Le code est beaucoup plus lisible maintenant.",
        date: "il y a 6j",
      },
    ],
    created: "il y a 10j",
    createdIso: "2025-01-05T10:00:00Z",
    updated: "il y a 6j",
  },
  {
    id: "mr-7",
    number: 34,
    title: "Ajout article 48 : Protection environnementale numérique",
    description: "Nouvel article sur l'empreinte carbone des infrastructures numériques VITA et les obligations de sobriété numérique.",
    project: "Constitution v3.0",
    projectId: "constitution-v3",
    author: "Luca Moretti",
    authorInitials: "LM",
    ...
    comments: [
      {
        ...
        author: "Marie Dupont",
        authorInitials: "MD",
        content: "L'intention est bonne mais les obligations proposées sont trop contraignantes pour être constitutionnelles. Je suggère de le reformuler en proposition de loi.",
        date: "il y a 8j",
      },
    ],
    created: "il y a 12j",
    createdIso: "2025-01-03T14:00:00Z",
    updated: "il y a 7j",
  },
  {
    id: "mr-8",
    number: 33,
    title: "Fix: Calcul du coefficient de service",
    description: "Correction d'un bug dans le calcul du coefficient de service qui arrondissait incorrectement les valeurs décimales.",
    project: "Système de Vote v2",
    projectId: "voting-system",
    author: "Jean Martin",
    authorInitials: "JM",
    ...
    comments: [],
    created: "il y a 15j",
    createdIso: "2024-12-31T11:00:00Z",
    updated: "il y a 12j",
  },
  {
    id: "mr-9",
    number: 32,
    title: "Ajout système de tags pour les propositions",
    description: "Permet d'associer des tags aux propositions pour faciliter la recherche et le filtrage.",
    project: "Système de Vote v2",
    projectId: "voting-system",
    author: "Marie Dupont",
    authorInitials: "MD",
    ...
    created: "il y a 20j",
    createdIso: "2024-12-26T09:00:00Z",
    updated: "il y a 18j",
  },
  {
    id: "mr-10",
    ...
    comments: [],
    created: "il y a 22j",
    createdIso: "2024-12-24T10:00:00Z",
    updated: "il y a 20j",
  },
];
...
// ============================================================
// CONTRIBUTORS (detailed for contributors page)
// ============================================================
...
export const FORGE_CONTRIBUTORS: ForgeContributor[] = [
  {
    id: "u1",
    name: "Marie Dupont",
    username: "mdupont",
    ...
    projets: ["Constitution v3.0", "Système de Vote v2"],
    derniereActivite: "il y a 2h",
    dateInscription: "2023-06-12",
    activiteRecente: [3, 5, 2, 0, 4, 1, 6],
  },
  {
    id: "u2",
    name: "Jean Martin",
  ...
  },
  {
    ...
    projets: ["Système de Vote v2"],
    derniereActivite: "il y a 8h",
    dateInscription: "2024-01-15",
    activiteRecente: [0, 2, 1, 3, 2, 0, 4],
  },
  {
    id: "u5",
    name: "Fatima Benali",
  ...
  },
  {
    ...
    projets: ["Constitution v3.0"],
    derniereActivite: "il y a 1j",
    dateInscription: "2024-03-18",
    activiteRecente: [1, 0, 2, 0, 1, 0, 3],
  },
  {
    id: "u7",
    name: "Aisha Nakamura",
  ...
  },
  {
    ...
    lignesSupprimees: 90,
    projets: ["Constitution v3.0"],
    derniereActivite: "il y a 7j",
    dateInscription: "2024-07-08",
    activiteRecente: [0, 0, 0, 1, 0, 0, 0],
  },
  {
    id: "u11",
    name: "Yuki Tanaka",
    ...
    lignesSupprimees: 65,
    projets: ["Constitution v3.0"],
    derniereActivite: "il y a 10j",
    dateInscription: "2024-08-15",
    activiteRecente: [0, 0, 0, 0, 0, 0, 0],
  },
  {
    id: "u12",
    name: "Clara Müller",
