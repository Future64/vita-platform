...
const ALL_PERMISSIONS: Permission[] = [
  ...
  'create_branch', 'create_commit', 'create_merge_request', 'approve_merge_request', 'merge_branch',
...
const CITOYEN_PERMISSIONS: Permission[] = [
  ...
  'propose_amendment',
  'create_branch', 'create_commit', 'create_merge_request',
...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  ...
  moderateur: [
    ...
    'create_proposal', 'vote_proposal', 'comment_proposal', 'moderate_proposal', 'delete_proposal',
    'propose_amendment',
    'create_branch', 'create_commit', 'create_merge_request', 'approve_merge_request',
    'send_vita', 'receive_vita', 'view_balance', 'view_transactions',
